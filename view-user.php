...
<head>
    ...
    <title>Detail Pengguna | Sewa Apartemen.id</title>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3><i class="fas fa-user me-2"></i>Detail Pengguna</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p class="form-control-plaintext"><?php echo date('d F Y', strtotime($user['created_at'])); ?></p>
                        </div>
                    </div>
                </div>
            </div>
