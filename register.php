...
<body>
    ...
    <div class="position-relative z-10 w-100" style="max-width: 32rem;">
        ...
        <div class="glass-effect p-4">
            ...
            <form id="registerForm" method="POST" action="register-proses.php">
                <!-- Name Input -->
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="phone" class="form-label fw-medium">
                        <i class="fas fa-phone me-2 text-indigo"></i>Nomor Telepon
                    </label>
                    <input 
                        type="tel" 
                ...
                <div class="mb-4">
                    ...
                    <div class="position-relative">
                        <input 
                            type="password" 
                            class="form-control form-control-lg input-focus <?php echo (!empty($confirm_password_err)) ? 'is-invalid' : ''; ?>" 
                            id="confirm_password" 
                ...
                <div class="mb-4">
                    <div class="form-check">
                        ...
                        <label class="form-check-label small" for="terms">
                            Saya setuju dengan <a href="#" class="text-decoration-none text-indigo">Syarat & Ketentuan</a> dan <a href="#" class="text-decoration-none text-indigo">Kebijakan Privasi</a>
                        </label>
                    </div>
                </div>
